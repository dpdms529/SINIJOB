...
@Database(entities = {JobCategory.class, Bdong.class, Recruit.class, RecruitCertificate.class, CvInfo.class, CoverLetter.class, Certificate.class}, version = 6, exportSchema = false)
